...
| `lab-cluster-1` | [`lab-cluster-1/SKILL.md`](lab-cluster-1/SKILL.md) | 在 lab cluster 1 / PJLAB 开发机上交互式登录后，使用已实测的原始 `rlaunch`/`rjob` 命令安全使用 CPU/GPU worker、提交任务、处理分区挂载、代理和服务访问。 |
