...
| `lab-cluster-1` | [`lab-cluster-1/SKILL.md`](lab-cluster-1/SKILL.md) | 在 lab cluster 1 / PJLAB 开发机上通过原始 `rlaunch`/`rjob` 命令安全使用 CPU/GPU worker、提交训练或部署任务，并处理分区、挂载、代理和服务访问。 |
